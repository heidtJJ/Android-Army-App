...
import com.example.android.armyapp.Modules.Resiliency_Mod.Resiliency_Adapter;
import com.example.android.armyapp.R;

public class Module_RetFromBasic extends Module_Starter {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        appBar.setTitle(R.string.returning_from_basic);
        ...
        moduleTitle.setText(getText(R.string.RetFromBasic_Mod_Title));
        TextView moduleDesc = findViewById(R.id.Module_Desc);// Module Description.
        moduleDesc.setText(getText(R.string.RetFromBasic_Mod_Desc));
        ...
        super.adapter = new RetFromBasic_Adapter(this, NUM_LESSONS_IN_MODULE);
