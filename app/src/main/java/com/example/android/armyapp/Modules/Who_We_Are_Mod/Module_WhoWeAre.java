...
public class Module_WhoWeAre extends Module_Starter {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        appBar.setTitle(R.string.who_are_we);
        ...
        moduleTitle.setText(getText(R.string.WhoWeAre_Mod_Title));
        TextView moduleDesc = findViewById(R.id.Module_Desc);// Module Description.
        moduleDesc.setText(getText(R.string.WhoWeAre_Mod_Desc));
        ...
        super.adapter = new WhoWeAre_Adapter(this, NUM_LESSONS_IN_MODULE);
